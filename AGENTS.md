...
js/weapons.js       # 武器系统：武器定义（手枪/步枪/霰弹枪/剑/镐）、子弹系统、近战攻击、第一人称武器3D渲染、伤害计算
js/game.js          # 游戏主模块：玩家控制、背包系统、武器/子弹管理、TouchController、物理系统、游戏循环
```
...
| 武器 | 类型 | 伤害 | 射速 | 弹匣 | 备注 |
|------|------|------|------|------|------|
| 手枪 | 远程 | 25 | 0.4s | 12发 | 基础武器，半自动 |
| 步枪 | 远程 | 15 | 0.12s | 30发 | 全自动，高射速 |
| 霰弹枪 | 远程 | 8×5 | 0.8s | 6发 | 近距离散射5发 |
| 剑 | 近战 | 40 | 0.5s | - | 近战挥砍 |
| 镐 | 近战 | 15 | 0.3s | - | 破坏方块3倍伤害 |
